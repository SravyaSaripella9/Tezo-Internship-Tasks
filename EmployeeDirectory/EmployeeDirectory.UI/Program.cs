...
namespace EmployeeDirectory.UI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IProjectRepository projectRepository = new ProjectRepository(projectGenericRepository, mapper);
            IDepartmentRepository departmentRepository = new DepartmentRepository(departmentGenericRepository, mapper);
            ILocationRepository locationRepository = new LocationRepository(locationGenericRepository, mapper);
