...
namespace EmployeeDirectory.UI
{
    class EmployeeManagementMenu : IEmployeeManagementMenu
    {
        ...
        public DateOnly GetDate()
        {
            ...
            DateOnly date = DateOnly.Parse(enteredDate);
            return date;
        }
        ...
        public string GetProject(List<Project> projects)
        {
            ...
            if (optionEntered == projects.Count + 1)
                return "";
            return projects[optionEntered-1].Name;
        }
        public int FetchProjectId(string project, List<Project> projects)
        {
            int projectId;
            if (project == "")
                projectId = 0;
            ...
            {
                Project projectSelected = projects.First(proj => proj.Name == project);
        ...
        public void GetEmployeeDetails()
        {
            ...
            Role selectedRole = roles.First(role => role.DepartmentId == department.Id);
            ...
            string project = GetProject(projects);
            int projectId = FetchProjectId(project, projects);
            Employee employee = new Employee(empNo, firstName, lastName, dateOfBirth, email, mobileNumber, joinDate, selectedRole.Id, manager, projectId, false);
            employeesController.AddEmployee(employee);
        }
        public void DisplayAllEmployees()
        {
            List<EmployeeViewModel> employeeViewModels = employeesController.GetEmployeeViewModels();
            ...
            else
            {
                ...
                {
                    Console.WriteLine($"Employee No.: {employeeViewModel.EmpNo}");
                    Console.WriteLine($"Employee First Name: {employeeViewModel.FirstName}");
                    Console.WriteLine($"Employee Last Name: {employeeViewModel.LastName}");
                    Console.WriteLine($"Employee Role: {employeeViewModel.RoleName}");
                    Console.WriteLine($"Employee Department: {employeeViewModel.DepartmentName}");
                    Console.WriteLine($"Employee Location: {employeeViewModel.LocationName}");
                    Console.WriteLine($"Employee Joining Date: {employeeViewModel.JoinDate}");
                    Console.WriteLine($"Employee Manager Name: {employeeViewModel.Manager}");
                    Console.WriteLine($"Employee Project Name: {employeeViewModel.ProjectName}");
                    Console.WriteLine("==============================================");
                }
            }
        }
        public void DisplayEmployee()
        {
            ...
            EmployeeViewModel? employeeToBeDisplayed = employeeViewModels.FirstOrDefault(emp => emp.EmpNo == empNo);
            ...
            {
                Console.WriteLine($"Employee No.: {employeeToBeDisplayed.EmpNo}");
                Console.WriteLine($"Employee First Name: {employeeToBeDisplayed.FirstName}");
                Console.WriteLine($"Employee Last Name: {employeeToBeDisplayed.LastName}");
                Console.WriteLine($"Employee Date Of Birth: {employeeToBeDisplayed.DateOfBirth}");
                Console.WriteLine($"Employee Email: {employeeToBeDisplayed.Email}");
                Console.WriteLine($"Employee Mobile Number: {employeeToBeDisplayed.MobileNumber}");
                Console.WriteLine($"Employee Role: {employeeToBeDisplayed.RoleName}");
                Console.WriteLine($"Employee Department: {employeeToBeDisplayed.DepartmentName}");
                Console.WriteLine($"Employee Location: {employeeToBeDisplayed.LocationName}");
                Console.WriteLine($"Employee Joining Date: {employeeToBeDisplayed.JoinDate}");
                Console.WriteLine($"Employee Manager Name: {employeeToBeDisplayed.Manager}");
                Console.WriteLine($"Employee Project Name: {employeeToBeDisplayed.ProjectName}");
            }
        }
        public void GetEmployeeDetailsToBeUpdated()
        {
            ...
            List<EmployeeViewModel> employeeViewModels = employeesController.GetEmployeeViewModels();
            EmployeeViewModel? employeeToBeEdited = employeeViewModels.FirstOrDefault(emp => emp.EmpNo == empNo);
